...
import {EXPERIMENTAL_SPA} from 'cliff/constants';
import {
  PROJECT_MOVED,
  SUDO_REQUIRED,
  SUPERUSER_REQUIRED,
} from 'cliff/constants/apiErrorCodes';
// import {openSudo, redirectToProject} from 'sentry/actionCreators/modal';
// import {metric} from 'sentry/utils/analytics';
import getCsrfToken from 'cliff/utils/getCsrfToken';
import {uniqueId} from 'cliff/utils/guid';
import createRequestError from 'cliff/utils/requestError/createRequestError';
...
export class Client {
  ...
  handleRequestError(
    {id, requestOptions}: HandleRequestErrorOptions,
